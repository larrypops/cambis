...
export function FloatingWhatsApp() {
  const whatsappNumber = "+237699689503";
  const message = encodeURIComponent("Bonjour, je souhaite un devis pour un service de nettoyage.");
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3 rounded-full shadow-2xl flex items-center justify-center hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] transition-shadow"
